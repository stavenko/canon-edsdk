...
CIso::CIso()
{
	...
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x93,"64000"));
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x95,"80000"));
	...
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0xb0,"819200"));
