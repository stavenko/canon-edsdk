    ...
    class GetPropertyDescCommand : Command
    {
        ...
        private uint GetPropertyDesc(uint propertyID)
        {
            ...
            if (propertyID == EDSDKLib.EDSDK.PropID_Unknown)
            {
                ...
                if (err == EDSDKLib.EDSDK.EDS_ERR_OK) err = this.GetPropertyDesc(EDSDKLib.EDSDK.PropID_PictureStyle);
                if (err == EDSDKLib.EDSDK.EDS_ERR_OK) err = this.GetPropertyDesc(EDSDKLib.EDSDK.PropID_MovieHFRSetting);
                return err;
            }
