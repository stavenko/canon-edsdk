...
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsGetChildAtIndex(EdsBaseRef inRef, EdsInt32 inIndex,
                                   EdsBaseRef *outRef);
...
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsGetPropertySize(EdsBaseRef inRef, EdsPropertyID inPropertyID,
                                   EdsInt32 inParam, EdsDataType *outDataType,
                                   EdsUInt32 *outSize);
...
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsGetPropertyData(EdsBaseRef inRef, EdsPropertyID inPropertyID,
                                   EdsInt32 inParam, EdsUInt32 inPropertySize,
...
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsSetPropertyData(EdsBaseRef inRef, EdsPropertyID inPropertyID,
                                   EdsInt32 inParam, EdsUInt32 inPropertySize,
...
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsGetPropertyDesc(EdsBaseRef inRef, EdsPropertyID inPropertyID,
...
EdsError EDSAPI EdsSendCommand(EdsCameraRef inCameraRef,
                               EdsCameraCommand inCommand, EdsInt32 inParam);
...
EdsError EDSAPI EdsDownload(EdsDirectoryItemRef inDirItemRef,
                            EdsUInt64 inReadSize, EdsStreamRef outStream);
...
EdsError EDSAPI EdsSetMetaImage(EdsDirectoryItemRef inDirItemRef,
                                EdsUInt32 inMetaType, EdsUInt32 inMetaDataSize,
...
EdsError EDSAPI EdsCreateFileStream(
    const EdsChar *inFileName, EdsFileCreateDisposition inCreateDisposition,
...
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsRead(EdsStreamRef inStreamRef, EdsUInt64 inReadSize,
                        EdsVoid *outBuffer, EdsUInt64 *outReadSize);
...
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsWrite(EdsStreamRef inStreamRef, EdsUInt64 inWriteSize,
...
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsSeek(EdsStreamRef inStreamRef, EdsInt64 inSeekOffset,
...
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsCopyData(EdsStreamRef inStreamRef, EdsUInt64 inWriteSize,
...
EdsError EDSAPI EdsGetImage(EdsImageRef inImageRef,
                            EdsImageSource inImageSource,
                            EdsTargetImageType inImageType, EdsRect inSrcRect,
                            EdsSize inDstSize, EdsStreamRef outStreamRef);
...
EdsError EDSAPI EdsSetPropertyEventHandler(
    EdsCameraRef inCameraRef, EdsPropertyEvent inEvnet,
...
EdsError EDSAPI EdsSetObjectEventHandler(
    EdsCameraRef inCameraRef, EdsObjectEvent inEvnet,
...
EdsError EDSAPI EdsSetCameraStateEventHandler(
    EdsCameraRef inCameraRef, EdsStateEvent inEvnet,
...
EdsError EDSAPI EdsSetFramePoint(EdsCameraRef inCameraRef,
                                 EdsPoint inFramepoint, bool inLockAfFrame);
