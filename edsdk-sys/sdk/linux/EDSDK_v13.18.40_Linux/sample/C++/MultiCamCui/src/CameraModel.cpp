...
EdsError CameraModel::SetApertureLock(const ApertureLockSetting* data, std::map<EdsUInt32, const char*> prop_table)
{
	EdsError err = EDS_ERR_OK;
	// Acquisition of the property
	EdsUInt32 datasize = sizeof(ApertureLockSetting);
